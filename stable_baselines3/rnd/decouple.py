...
SelfDecoupleDQN = TypeVar("SelfDecoupleDQN", bound="DecoupleDQN")

class DecoupleDQN(RND):
    ...
    def __init__(
        ...
        self.exploit_policy = DQN(
            ...
            exploit_policy_max_grad_norm,
            tensorboard_log,
            exploit_policy_kwargs,
            0, # verbose
            seed,
            device,
            _init_setup_model,
